...
function googleLoaded() {
	...
	$.get("https://www.googleapis.com/fusiontables/v1/query?sql=SELECT+*+FROM+1sqxKGNmK_aKGBk1hGpO8xyfGXxRnOoWUCCux3OsX&key=AIzaSyCzc9XKi4CG-PcqBZfHBmc3fKmuq3JH9vU", dataLoaded, "json");
